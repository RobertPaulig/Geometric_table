...
8. `src/hetero2/*` — реализация пайплайна (batch/pipeline/decoys/audit/operator).
9. `docs/artefacts_registry.md` — истина артефактов (asset URL + SHA256 + команда + outcome).
10. `docs/90_lineage.md` — append-only хронология мерджей/релизов и причинно-следственная линия.
