...
## accuracy-a1-isomers-2026-01-24-a3_3-r1

- Source commit: ded14dd9736d1dbe1a5da3e5a74e3163e9dd6379
- Release asset: https://github.com/RobertPaulig/Geometric_table/releases/download/accuracy-a1-isomers-2026-01-24-a3_3-r1/accuracy_a1_isomers_evidence_pack.zip
- SHA256(accuracy_a1_isomers_evidence_pack.zip): 9E335BB369578483E4C9CAA256DADB3D3107C5FDE82AE79352B4116F7B49C7D8
- Command:
  python scripts/build_isomer_truth_v1.py
  python scripts/accuracy_a1_isomers_a3_3_phase_rho_pivot.py --experiment_id ACCURACY-A3.3 --input_csv data/accuracy/isomer_truth.v1.csv --out_dir out_accuracy_a1_isomers_a3_3 --seed 0
- Outcome (facts from metrics.json):
