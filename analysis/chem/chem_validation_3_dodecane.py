...
def _parse_args(argv: Optional[Sequence[str]] = None) -> Config:
    ap = argparse.ArgumentParser(
        description="CHEM-VALIDATION-3: C12 (dodecane) equilibrium-first + self-consistency + Wiener sanity."
    )
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    write_report_and_csv(
        out_stub="chem_validation_3_dodecane",
        cfg=cfg,
        p_eq=p_eq,
        meta=meta,
        p_pred=p_pred,
