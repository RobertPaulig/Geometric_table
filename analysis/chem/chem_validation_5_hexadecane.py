...
class Config:
    ...
    chains: int = 5
    steps_init: int = 80_000_000
    max_steps: int = 320_000_000
    thin: int = 10
    eq_seed: int = 0
...
def _parse_args(argv: Optional[Sequence[str]] = None) -> Config:
    ap = argparse.ArgumentParser(description="CHEM-VALIDATION-5: C16 (hexadecane) growth vs equilibrium, Mode A only.")
